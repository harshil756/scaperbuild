...
export default function CommercialPestControlPage() {
  ...
  return (
    <>
      <ServiceCmsStyles content={c} heroBgId="d694001" ctaBgId="d694002" />
      ...
      <div className="elementor elementor-694" data-elementor-id={694} data-elementor-post-type="page" data-elementor-type="wp-page">
        <div className="elementor-element elementor-element-d694001 e-flex e-con-boxed e-con e-parent e-lazyloaded" data-element_type="container" data-id="d694001" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
          <div className="e-con-inner">
            <div className="elementor-element elementor-element-d694010 e-con-full e-flex e-con e-child" data-element_type="container" data-id="d694010">
              <div className="elementor-element elementor-element-d694011 elementor-icon-list--layout-inline elementor-align-left elementor-widget__width-auto elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-element_type="widget" data-id="d694011" data-widget_type="icon-list.default">
                <div className="elementor-widget-container">
              ...
              <div className="elementor-element elementor-element-d694014 elementor-widget elementor-widget-text-editor" data-element_type="widget" data-id="d694014" data-widget_type="text-editor.default">
                <div className="elementor-widget-container"><CmsHtml html={c?.hero?.intro} /></div>
              </div>
            </div>
            <div className="elementor-element elementor-element-d694015 e-con-full e-flex e-con e-child" data-element_type="container" data-id="d694015" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
              ...
              <div className="elementor-element elementor-element-d694017 elementor-widget elementor-widget-heading" data-element_type="widget" data-id="d694017" data-widget_type="heading.default">
                <div className="elementor-widget-container">
                  <h6 className="elementor-heading-title elementor-size-default">{cmsText(c?.quote_form?.subtitle, 'Have an enquiry? Leave us your details and we’ll call you back during business hours.')}</h6>
                </div>
              </div>
              <div className="elementor-element elementor-element-d694018 elementor-button-align-center elementor-widget elementor-widget-form" data-element_type="widget" data-id="d694018" data-widget_type="form.default">
                <div className="elementor-widget-container">
                  <form aria-label="Quote form" className="elementor-form" id="commercial_contact_form" method="post" name="Quote form">
                    ...
                    <div className="elementor-form-fields-wrapper elementor-labels-">
                      <div className="elementor-field-type-text elementor-field-group elementor-column elementor-col-100 elementor-field-required">
                        <input className="elementor-field elementor-size-md elementor-field-textual" name="form_fields[first_name]" placeholder="Name" required type="text" />
                      </div>
                      <div className="elementor-field-type-email elementor-field-group elementor-column elementor-col-100 elementor-field-required">
                        <input className="elementor-field elementor-size-md elementor-field-textual" name="form_fields[user_email]" placeholder="Email" required type="email" />
                      </div>
                      <div className="elementor-field-type-tel elementor-field-group elementor-column elementor-col-100 elementor-field-required">
                        <PhoneNumberInput className="elementor-field elementor-size-md elementor-field-textual" name="form_fields[mobile_number]" placeholder="Mobile Number" required />
                      </div>
                      <div className="elementor-field-group elementor-column elementor-col-100 e-form__buttons">
            ...
            <div className="elementor-column elementor-col-100">
              <div className="elementor-widget-wrap elementor-element-populated">
                <div className="elementor-element elementor-element-d694020 elementor-widget elementor-widget-heading" data-element_type="widget" data-id="d694020" data-widget_type="heading.default">
                  <div className="elementor-widget-container">
                    <h2 className="elementor-heading-title elementor-size-default">Our Commercial Services</h2>
                  </div>
                </div>
                <div className="elementor-element elementor-element-d694021 elementor-widget elementor-widget-heading" data-element_type="widget" data-id="d694021" data-widget_type="heading.default">
                  <div className="elementor-widget-container">
                    <h2 className="elementor-heading-title elementor-size-default">Specialised Pest Control for Every Business Type</h2>
                  </div>
                </div>
                <div className="elementor-element elementor-element-d694022 elementor-widget elementor-widget-text-editor" data-element_type="widget" data-id="d694022" data-widget_type="text-editor.default">
                  <div className="elementor-widget-container">
                    <p>Choose the commercial pest control service that matches your industry.</p>
                  </div>
                </div>
                <div className="elementor-element elementor-element-d694023 e-flex e-con-boxed e-con e-parent" data-element_type="container" data-id="d694023">
                  <div className="e-con-inner">
                    <ServiceCard widgetId="c1a1001" title="Office Pest Control" path="/office-pest-control" image="/assets/images/people-disinfecting-biohazard-area-2048x1365-1_b73d3038.jpg" alt="Office Pest Control" />
                    <ServiceCard widgetId="c1a1002" title="Restaurant & Cafe Pest Control" path="/restaurant-cafe-pest-control" image="/assets/images/restaurant-cafe-pest-control_a32fdd7d.bin" alt="Restaurant Pest Control" />
                    <ServiceCard widgetId="c1a1003" title="School & Hospitality Facility Pest Control" path="/school-and-hospitality-facility-pest-control" image="/assets/images/school-and-hospitality-facility-pest-control_428bbe0c.bin" alt="School Pest Control" />
                    <ServiceCard widgetId="c1a1004" title="Warehouse & Factory Pest Control" path="/warehouse-and-factory-pest-control-services-melbourne" image="/assets/images/warehouse-and-factory-pest-control-services-melbourne_a0cf5c90.bin" alt="Warehouse Pest Control" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="elementor-column elementor-col-100">
              <div className="elementor-widget-wrap elementor-element-populated">
                ...
                <div className="elementor-element elementor-element-d694031 elementor-widget elementor-widget-heading" data-element_type="widget" data-id="d694031" data-widget_type="heading.default">
                  <div className="elementor-widget-container">
                    <h2 className="elementor-heading-title elementor-size-default">Contact 7 States Pest Control for Commercial Pest Control</h2>
                  </div>
                </div>
                <div className="elementor-element elementor-element-d694032 elementor-widget elementor-widget-text-editor" data-element_type="widget" data-id="d694032" data-widget_type="text-editor.default">
                  <div className="elementor-widget-container">
                    <p>Don’t let pests disrupt your business. Contact <Link to="/"><strong>7 States Pest Control</strong></Link> today.</p>
                  </div>
                </div>
