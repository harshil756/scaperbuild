...
export default function TermsAndConditionsPage() {
  ...
  return (
    <div className="elementor elementor-terms" data-elementor-type="wp-page">
            ...
            <div className="elementor-widget-wrap elementor-element-populated">
              <div className="elementor-widget elementor-widget-heading">
                <div className="elementor-widget-container">
                  <h1 className="elementor-heading-title elementor-size-default">Terms &amp; Conditions</h1>
                </div>
              </div>
          ...
          <div className="elementor-column elementor-col-100 elementor-top-column">
            <div className="elementor-widget-wrap elementor-element-populated">
              <div className="elementor-widget elementor-widget-text-editor">
                <div className="elementor-widget-container entry-content">
                  <p>
                  ...
                  <h2>2. Free quotations</h2>
                  <p>
                    Where we offer a free quotation, this covers assessment and pricing only unless otherwise stated in
                    writing. Treatment, reporting, or compliance documentation may incur separate charges.
                  </p>

                  <h2>3. Access and preparation</h2>
                  <p>
                  ...
                  <h2>7. Health, safety, and chemicals</h2>
                  <p>
                  ...
                  <h2>9. End-of-lease and compliance reports</h2>
                  <p>
