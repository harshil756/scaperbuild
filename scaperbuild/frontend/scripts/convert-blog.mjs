...
function findHtmlFile() {
  ...
  throw new Error('blog.html not found')
}
...
const outPath = path.join(frontend, 'src/pages/BlogPage.jsx')
fs.writeFileSync(
  outPath,
...
fs.writeFileSync(
  path.join(frontend, 'src/config/blogPageMeta.js'),
