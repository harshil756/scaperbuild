...
export default function OurServicesTermitePestControlPage() {
  usePageMeta('our_services_termite_pest_control')
          ...
          <div className="e-con-inner">
            <div className="elementor-element elementor-element-65fcf03 e-con-full e-flex e-con e-child" data-element_type="container" data-id="65fcf03">
                  ...
                  <ul className="elementor-icon-list-items elementor-inline-items">
                    ...
                    <li className="elementor-icon-list-item elementor-inline-item">
                      <a href="#">
                        <span className="elementor-icon-list-icon">
                          <svg aria-hidden="true" className="e-font-icon-svg e-fas-angle-right" viewBox="0 0 256 512" xmlns="http://www.w3.org/2000/svg"><path d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z" /></svg> </span>
                        <span className="elementor-icon-list-text">termite pest control</span>
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              <div className="elementor-element elementor-element-5b29971 elementor-widget elementor-widget-heading animated fadeInDown" data-element_type="widget" data-id="5b29971" data-settings="{&quot;_animation&quot;:&quot;fadeInDown&quot;}" data-widget_type="heading.default">
                <div className="elementor-widget-container">
                  <h2 className="elementor-heading-title elementor-size-default">termite pest control</h2> </div>
              </div>
              <div className="elementor-element elementor-element-f59a88c elementor-widget elementor-widget-heading animated fadeInLeft" data-element_type="widget" data-id="f59a88c" data-settings="{&quot;_animation&quot;:&quot;fadeInLeft&quot;}" data-widget_type="heading.default">
                <div className="elementor-widget-container">
                  <h1 className="elementor-heading-title elementor-size-default">Get Professional Termite Control in Melbourne</h1> </div>
              </div>
              <div className="elementor-element elementor-element-424a488 elementor-widget elementor-widget-text-editor" data-element_type="widget" data-id="424a488" data-widget_type="text-editor.default">
                <div className="elementor-widget-container">
                  <p className="font-claude-response-body break-words whitespace-normal leading-[1.7]">Termites are silent destroyers that can cause serious structural damage before you even realise they are present. Unlike other pests, termites work behind walls, under floors, and inside wooden structures — making early detection difficult. Without professional <strong>termite pest control</strong>, the damage can become expensive and dangerous.</p><p className="font-claude-response-body break-words whitespace-normal leading-[1.7]">If you are noticing signs of termite activity and searching for reliable <strong>termite control Melbourne</strong> or expert <strong>termite treatment Melbourne</strong>, you are in the right place.</p><p className="font-claude-response-body break-words whitespace-normal leading-[1.7]">At <Link className="underline underline underline-offset-2 decoration-1 decoration-current/40 hover:decoration-current focus:decoration-current" to="/">7 States Pest Control</Link>, we specialise in advanced <strong>termite pest control</strong>, effective <strong>termite removal Melbourne</strong>, and long-term <strong>termite barrier</strong> solutions tailored to residential and commercial properties. Our licensed technicians deliver safe, compliant, and highly effective <strong>termite control</strong> across Melbourne — protecting your home before costly damage sets in.</p> </div>
              </div>
            </div>
