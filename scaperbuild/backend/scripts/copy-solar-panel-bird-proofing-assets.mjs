#!/usr/bin/env node
/**
 * Copy solar-panel-bird-proofing page images to backend storage.
 */
...
const dataFile = path.join(__dirname, '../database/data/solar-panel-bird-proofing-page.json')
const srcDir = path.join(__dirname, '../../frontend/public/assets/images')
const destDir = path.join(__dirname, '../storage/app/public/cms/solar-panel-bird-proofing')

if (!fs.existsSync(dataFile)) {
  console.error('Run extract-solar-panel-bird-proofing-cms.mjs first.')
  process.exit(1)
}
