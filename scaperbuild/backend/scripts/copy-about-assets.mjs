#!/usr/bin/env node
/**
 * Copy about-us page images from frontend/public/assets/images to backend storage.
 */
...
const dataFile = path.join(__dirname, '../database/data/about-page.json')
const srcDir = path.join(root, 'frontend/public/assets/images')
const destDir = path.join(__dirname, '../storage/app/public/cms/about')

if (!fs.existsSync(dataFile)) {
  console.error('Run extract-about-cms.mjs first.')
  process.exit(1)
}
